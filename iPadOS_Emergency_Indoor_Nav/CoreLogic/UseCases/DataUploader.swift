...
class DataUploader {
  ...
  func loadEdges() {
    let edges = [("R-A1","R-A2",false,"",0.0,0.0),//can be deactivated
                 ("R-A1","W-5",true,"Zone 5", -121.89012676477431, 37.32892165050638),
                 ("R-A2","W-7",true,"Zone 7", -121.88966274261475, 37.32910240554742),
                 ("R-B1","R-B2",false,"",0.0,0.0),//can be deactivated
                 ("R-B1","W-8",true,"Zone 8", -121.88944078981878, 37.32912373354719),
                 ("R-B2","W-23",true,"Zone 23", -121.88898950815201, 37.32933168122753),
                 ("R-C1","R-C2",false,"",0.0,0.0),
                 ("R-C1","W-13",true,"Zone 13", -121.888762190938, 37.32933754641018),
                 ("R-C2","W-14",true,"Zone 14", -121.88831493258476, 37.32955189186158),
                 ("R-D1","R-D2",false,"",0.0,0.0),//can be deactivated
                 ("R-D1","W-18",true,"Zone 18", -121.88809365034103, 37.329534829559506),
                 ("R-D2","W-19",true,"Zone 19", -121.88784286379814, 37.329209578685),
                 ...
                 ("R-M1","W-9",true,"Zone 9", -121.88946962356567, 37.32932581604445),
                 ("R-M2","W-10",true,"Zone 10", -121.88928857445717, 37.329407928566134),
